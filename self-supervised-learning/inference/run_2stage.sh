python inference_2stage.py --config-file /workspace/inference/configs/v2_stable_config.yaml \
        --pretrained-weights /workspace/weights/v2_stable_e400/training_499999/teacher_checkpoint.pth \
        --test-dataset osteo_3cls:root=/workspace/dataset/3-cls-external/GH_FM_3cls/test  \
        --batch-size 1 \
        --training-num-classes 2 \
        --pretrained-linear1 /workspace/inference/weights_linear/2cls_best/sampler_gelee_freeze_1K_30e_classifier_1_blocks_avgpool_True_lr_0_00125.pth \
        --pretrained-linear2 /workspace/inference/weights_linear/penia/penia_32500_1K_classifier_4_blocks_avgpool_True_lr_0_00003.pth
