...
python  dinov2/run/eval/linear_1024.py \
    ...
    --output-dir /workspace/eval/penia/training_1K_penia_2 \
    --train-dataset penia:root=/workspace/dataset/labelV6_AMC_FM_5cls/train \
    --val-dataset penia:root=/workspace/dataset/labelV6_AMC_FM_5cls/valid \
    --test-datasets penia:root=/workspace/dataset/labelV6_AMC_FM_5cls/test
